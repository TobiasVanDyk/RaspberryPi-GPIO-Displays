...
Note that this means the [**Waveshare 3.2" B display**](https://www.waveshare.com/product/displays/lcd-oled/lcd-oled-2/3.2inch-rpi-lcd-b.htm) will also work in excactly the same way as detailed above, with kernel 5.45
