...
**Update 16 Aug 2020:** **Now confirmed to be working as well for a Raspberry Pi 4B (4GB):** See the [**Video of Raspberry Pi 4B and kernel 5.4 with Waveshare LCD C**](VideoPi4BK54LC35C.mp4) or refer to [**Display 1**](https://github.com/goodtft/LCD-show/issues/223#issuecomment-670673815) and [**Display 2**](https://github.com/goodtft/LCD-show/issues/223#issuecomment-667666150), and see details below.
