...
**Confirmed to be working as well for a Raspberry Pi 4B (4GB):** [**Video Pi4 kernel5.4 LCD C**](VideoPi4BK54LC35C.mp4) [**Display 1**](https://github.com/goodtft/LCD-show/issues/223#issuecomment-670673815) and [**Display 2**](https://github.com/goodtft/LCD-show/issues/223#issuecomment-667666150), and see details below.
